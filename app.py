...
st.subheader('Price vs50-day moving average (MA50) and the 100-day moving average (MA100)')
...
st.subheader('Price vs 100-day moving average (MA100) and the 200-day moving average (MA200)')
...
plt.plot(data_test.index[100:], predict, 'r', label='Original Price')
plt.plot(data_test.index[100:], y, 'g', label='Predicted Price')
plt.xlabel('Time')
plt.ylabel('Price')
plt.show()
st.pyplot(fig4)